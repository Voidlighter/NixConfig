...
# and in the NixOS manual (accessible by running ‘nixos-help’).
{
  ...
  config = {
    ...
    services = {
      # displayManager.sddm.wayland.enable = config.greeter == "sddm";
      # displayManager.sddm.enable = config.greeter == "sddm";
      # desktopManager.plasma6.enable = config.desktop-manager == "plasma";
      displayManager.sddm.wayland.enable = true;
      displayManager.sddm.enable = true;
      desktopManager.plasma6.enable = true;
      xserver = {
        enable = true;
        # displayManager.gdm.enable = config.greeter == "gdm";
        # desktopManager.gnome.enable = config.desktop-manager == "gnome";
      };
    };
