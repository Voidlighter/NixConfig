{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-b968e0da-a74f-43e0-9629-4ad4a37cb63f" = [ ];
    ...
    configFile = {
      ...
      "dolphinrc"."General"."ViewPropsTimestamp" = "2025,1,2,14,8,10.497";
      "dolphinrc"."KFileDialog Settings"."Places Icons Auto-resize" = false;
      "dolphinrc"."KFileDialog Settings"."Places Icons Static Size" = 22;
      "kactivitymanagerdrc"."activities"."b968e0da-a74f-43e0-9629-4ad4a37cb63f" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "b968e0da-a74f-43e0-9629-4ad4a37cb63f";
      ...
      "kwinrc"."Desktops"."Id_1" = "66556efa-3f3b-4ccc-adaf-f8fb6aaed682";
      "kwinrc"."Desktops"."Number" = 1;
      "kwinrc"."Desktops"."Rows" = 1;
      "kwinrc"."Tiling"."padding" = 4;
      "kwinrc"."Tiling/81edfc82-a00b-55ff-9f47-4f822d9988d4"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/8f7ff032-a731-523b-a971-909662cec522"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
