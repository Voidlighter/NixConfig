{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-bb71db72-e0a3-4c62-9d9a-22696c4c7571" = [];
      ...
      "ksmserver"."Lock Session" = ["Screensaver" "Meta+X,Meta+L" "Screensaver,Lock Session"];
      ...
      "kwin"."KrohnkitePreviousLayout" = "Meta+Shift+Space,none,Krohnkite: Previous Layout";
    ...
    configFile = {
      ...
      "dolphinrc"."General"."ViewPropsTimestamp" = "2024,7,22,15,24,49.167";
      "dolphinrc"."KFileDialog Settings"."Places Icons Auto-resize" = false;
      "dolphinrc"."KFileDialog Settings"."Places Icons Static Size" = 22;
      "kactivitymanagerdrc"."activities"."bb71db72-e0a3-4c62-9d9a-22696c4c7571" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "bb71db72-e0a3-4c62-9d9a-22696c4c7571";
      ...
      "katerc"."KTextEditor::Search"."Search History" = "database";
      ...
      "katerc"."lspclient"."AllowedServerCommandLines" = "/etc/profiles/per-user/cade/bin/nil";
      ...
      "kcminputrc"."Libinput/1118/2496/Microsoft Surface Type Cover Touchpad"."ClickMethod" = 2;
      "kcminputrc"."Libinput/1118/2496/Microsoft Surface Type Cover Touchpad"."NaturalScroll" = true;
      "kcminputrc"."Libinput/1118/2496/Microsoft Surface Type Cover Touchpad"."PointerAcceleration" = 0.200;
      "kcminputrc"."Libinput/1118/2496/Microsoft Surface Type Cover Touchpad"."ScrollFactor" = 0.3;
      "kded5rc"."Module-device_automounter"."autoload" = false;
      "kdeglobals"."DirSelect Dialog"."DirSelectDialog Size" = "820,584";
      "kdeglobals"."Icons"."Theme" = "Tela-circle-light";
      ...
      "kscreenlockerrc"."Greeter/Wallpaper/org.kde.image/General"."Image" = "/home/cade/Pictures/Wallpapers/Elysium.jpg";
      "kscreenlockerrc"."Greeter/Wallpaper/org.kde.image/General"."PreviewImage" = "/home/cade/Pictures/Wallpapers/Elysium.jpg";
      "kwalletrc"."Wallet"."First Use" = false;
      "kwinrc"."Desktops"."Id_1" = "c9776728-3b07-4edd-b7f4-b47f95cd391f";
      "kwinrc"."Desktops"."Number" = 1;
      "kwinrc"."Desktops"."Rows" = 1;
      "kwinrc"."NightColor"."Active" = true;
      "kwinrc"."NightColor"."EveningBeginFixed" = 2200;
      "kwinrc"."NightColor"."LatitudeFixed" = 41.221374045801525;
      ...
      "kwinrc"."Tiling/ce828cff-a389-5e84-ad1d-272ebf8d817f"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/d4e3f750-19d1-5246-8f14-73f1bd99e518"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Xwayland"."Scale" = 2;
      "kxkbrc"."Layout"."LayoutList" = "us";
      "kxkbrc"."Layout"."Options" = "caps:backspace,grp:alt_space_toggle,compose:ralt";
      ...
      "plasmarc"."Wallpapers"."usersWallpapers" = "/home/cade/Pictures/Wallpapers/Elysium.jpg";
    ...
    dataFile = {
      ...
      "kate/anonymous.katesession"."Document 0"."URL" = "file:///home/cade/Repos/Jovian-NixOS/flake.nix";
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-H-Splitter" = "0,1295,0";
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-0-Splitter" = 749;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-1-Splitter" = 749;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-2-Splitter" = 1295;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-3-Splitter" = 936;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-V-Splitter" = "0,749,0";
      ...
      "kate/anonymous.katesession"."MainWindow0-Splitter 0"."Sizes" = 1295;
      ...
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/home\\/cade\\/Repos\\/Jovian-NixOS\\/README.md"."ScrollLine" = 30;
