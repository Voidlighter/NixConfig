    ...
    in {
      ...
      nixosConfigurations = {
        veridia = nixpkgs.lib.nixosSystem {
          ...
          inherit system pkgs;
          modules = [ ./hosts/veridia/default.nix ];
        };
        elysia = nixpkgs.lib.nixosSystem {
          specialArgs = { inherit inputs outputs; };
          inherit system pkgs;
          modules = [ ./hosts/elysia/default.nix ];
        };
        crateria = nixpkgs.lib.nixosSystem {
          specialArgs = { inherit inputs outputs; };
          inherit system pkgs;
          modules = [ ./hosts/crateria/default.nix ];
        };
        vapor = nixpkgs.lib.nixosSystem {
          specialArgs = { inherit inputs outputs; };
          inherit system pkgs;
          modules = [ ./hosts/vapor/default.nix ];
        };
        laserbeak = nixpkgs.lib.nixosSystem {
          specialArgs = { inherit inputs outputs; };
          inherit system pkgs;
          modules = [ ./hosts/laserbeak/default.nix ];
        };
      };
